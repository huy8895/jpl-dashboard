...
import io.huy8895.ipldashboard.data.MatchDataProcessor;
import io.huy8895.ipldashboard.data.MatchInput;
...
public class BatchConfig {
    ...
    public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Match>()
                ...
                .sql(" INSERT INTO match (id, city, date, player_of_match, venue, neutral_venue, team1, team2, " +
                        " toss_winner, toss_decision, match_winner, result, result_margin, umpire1, umpire2) " +
                        " VALUES (:id, :city, :date, :playerOfMatch, :venue, :neutralVenue, :team1, :team2, " +
    ...
    @Bean
    public Job importMatchJob(JobCompletionNotificationListener listener,
                              Step step1) {
